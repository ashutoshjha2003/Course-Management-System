...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@course-management-syste.fao9cha.mongodb.net/?retryWrites=true&w=majority&appName=course-management-system`;
...
async function run() {
  try {
    ...
    const database = client.db("course-management");
